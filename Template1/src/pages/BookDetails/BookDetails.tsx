    ...
    <>
      {!isLoading ? (
        <div className='w-screen h-screen overflow-auto bg-background'>
          <Sidebar></Sidebar>
          <div className='bg-background pt-2 pl-[7rem] lg:pl-[8rem] w-full h-screen overflow-auto'>
            ...
            <div className='flex flex-col lg:flex-row items-center gap-y-3 shadow-md mt-12 mr-14 p-3'>
              <img
                className='w-32 h-32 lg:w-60 lg:h-[23rem]'
