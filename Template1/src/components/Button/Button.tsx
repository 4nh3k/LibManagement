...
const Button: React.FC<ButtonProps> = ({bg_color, label, icon, color, border_color=""}) => {
  return (
    <button style={{backgroundColor: bg_color, borderColor: border_color, borderWidth: 2}} className={`text-${color} inline-flex items-center justify-center w-50 p-2 rounded-md`}>
